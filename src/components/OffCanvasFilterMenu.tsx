...
const OffCanvasFilterMenu = ({open, close}: {open: boolean, close: () => void}) => {
  ...
  return (
    <>
      ...
      >
        <div className="pointer-events-auto w-screen md:w-[500px]"> {/* Panel dimensions */}
          <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl rounded-2xl"> {/* Styling */}

            {/* Header */}
            <div className="flex items-center justify-between py-4 px-4 sm:px-6 flex-shrink-0">
              <h2 id="filter-panel-title" className="text-2xl font-bold leading-[120%] text-[#131316]">
                Filter
              </h2>
              <button
                type="button"
            ...
            <div className="relative flex-1 py-6 px-4 sm:px-6 space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input type='date' className='flex-1 bg-[#EFF1F6] py-3.5 px-4 rounded-2xl' value='2023-07-23' />
                  <input type='date' className='flex-1 bg-[#EFF1F6] py-3.5 px-4 rounded-2xl' value='2023-08-17' />
                </div>
              </div>
