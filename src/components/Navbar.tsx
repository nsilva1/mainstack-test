        ...
        <nav className='fixed top-3 left-4 right-4 z-50 flex justify-between items-center bg-white shadow-lg p-4 rounded-full h-16'>
            ...
            <div>
                <div className='flex gap-4 items-center justify-center'>
                    ...
                    <button onClick={() => setShowMenu((prev) => !prev)} className='bg-[#EFF1F6] p-2 rounded-full flex gap-4 items-center cursor-pointer'>
                    ...
                    <div className={`${showMenu ? 'flex' : 'hidden'} absolute top-20 right-4 min-w-[300px] z-50`}>
